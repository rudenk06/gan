...
def show_image():
    dataset = ImageDataset(root_dir=r"C:\Users\alexa\.cache\kagglehub\datasets\adityachandrasekhar\image-super-resolution\versions\\2\dataset\train")
    loader = DataLoader(dataset, batch_size=128, num_workers=4)
    # Create a figure with two subplots
    fig, axs = plt.subplots(1, 2, figsize=(8, 4))
    for idx, (low_res, high_res) in enumerate(loader):
        # Display the first image in the left subplot
        axs[0].imshow(low_res[8].permute(1, 2, 0))
        axs[0].set_title("low res")

        # Display the second image in the right subplot
        axs[1].imshow(high_res[8].permute(1, 2, 0))
...
def plot_examples(gen):
    dataset_test = ImageDataset(root_dir=r"C:\Users\alexa\.cache\kagglehub\datasets\adityachandrasekhar\image-super-resolution\versions\\2\dataset\val")
...
if __name__ == "__main__":
    ...
    train = ImageDataset(root_dir=r"C:\Users\alexa\.cache\kagglehub\datasets\adityachandrasekhar\image-super-resolution\versions\\2\dataset\train")
    train_loader = DataLoader(train, batch_size=batch_size, num_workers=num_workers)

    val = ImageDataset(root_dir=r"C:\Users\alexa\.cache\kagglehub\datasets\adityachandrasekhar\image-super-resolution\versions\\2\dataset\val")
